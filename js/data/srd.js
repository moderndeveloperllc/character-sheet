...
const SPELL_DATA = {
  // ---- Cantrips (Level 0) ----
  acidSplash: { name: 'Acid Splash', level: 0, school: 'Conjuration', classes: ['sorcerer', 'wizard'], concentration: false },
  bladeWard: { name: 'Blade Ward', level: 0, school: 'Abjuration', classes: ['bard', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  chillTouch: { name: 'Chill Touch', level: 0, school: 'Necromancy', classes: ['sorcerer', 'warlock', 'wizard'], concentration: false },
  ...
  eldritchBlast: { name: 'Eldritch Blast', level: 0, school: 'Evocation', classes: ['warlock'], concentration: false },
  fireBolt: { name: 'Fire Bolt', level: 0, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  poisonSpray: { name: 'Poison Spray', level: 0, school: 'Conjuration', classes: ['druid', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  ...
  produceFlame: { name: 'Produce Flame', level: 0, school: 'Conjuration', classes: ['druid'], concentration: false },
  rayOfFrost: { name: 'Ray of Frost', level: 0, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  resistance: { name: 'Resistance', level: 0, school: 'Abjuration', classes: ['cleric', 'druid'], concentration: true },
  sacredFlame: { name: 'Sacred Flame', level: 0, school: 'Evocation', classes: ['cleric'], concentration: false },
  shillelagh: { name: 'Shillelagh', level: 0, school: 'Transmutation', classes: ['druid'], concentration: false },
  shockingGrasp: { name: 'Shocking Grasp', level: 0, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  thornWhip: { name: 'Thorn Whip', level: 0, school: 'Transmutation', classes: ['druid'], concentration: false },
  trueStrike: { name: 'True Strike', level: 0, school: 'Divination', classes: ['bard', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  viciousMockery: { name: 'Vicious Mockery', level: 0, school: 'Enchantment', classes: ['bard'], concentration: false },
  ...
  burningHands: { name: 'Burning Hands', level: 1, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  charmPerson: { name: 'Charm Person', level: 1, school: 'Enchantment', classes: ['bard', 'druid', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  chromaticOrb: { name: 'Chromatic Orb', level: 1, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  dissonantWhispers: { name: 'Dissonant Whispers', level: 1, school: 'Enchantment', classes: ['bard'], concentration: false },
  ...
  guidingBolt: { name: 'Guiding Bolt', level: 1, school: 'Evocation', classes: ['cleric'], concentration: false },
  ...
  hellishRebuke: { name: 'Hellish Rebuke', level: 1, school: 'Evocation', classes: ['warlock'], concentration: false },
  ...
  inflictWounds: { name: 'Inflict Wounds', level: 1, school: 'Necromancy', classes: ['cleric'], concentration: false },
  ...
  magicMissile: { name: 'Magic Missile', level: 1, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  thunderwave: { name: 'Thunderwave', level: 1, school: 'Evocation', classes: ['bard', 'druid', 'sorcerer', 'wizard'], concentration: false },
  unseenServant: { name: 'Unseen Servant', level: 1, school: 'Conjuration', classes: ['bard', 'warlock', 'wizard'], concentration: false, ritual: true },
  witchBolt: { name: 'Witch Bolt', level: 1, school: 'Evocation', classes: ['sorcerer', 'warlock', 'wizard'], concentration: true },
  ...
  cloudOfDaggers: { name: 'Cloud of Daggers', level: 2, school: 'Conjuration', classes: ['bard', 'sorcerer', 'warlock', 'wizard'], concentration: true },
  ...
  flameBlade: { name: 'Flame Blade', level: 2, school: 'Evocation', classes: ['druid'], concentration: true },
  flamingSphere: { name: 'Flaming Sphere', level: 2, school: 'Conjuration', classes: ['druid', 'sorcerer', 'wizard'], concentration: true },
  ...
  heatMetal: { name: 'Heat Metal', level: 2, school: 'Transmutation', classes: ['bard', 'druid'], concentration: true },
  ...
  melfsAcidArrow: { name: "Melf's Acid Arrow", level: 2, school: 'Evocation', classes: ['wizard'], concentration: false },
  ...
  moonbeam: { name: 'Moonbeam', level: 2, school: 'Evocation', classes: ['druid'], concentration: true },
  ...
  rayOfEnfeeblement: { name: 'Ray of Enfeeblement', level: 2, school: 'Necromancy', classes: ['warlock', 'wizard'], concentration: true },
  scorchingRay: { name: 'Scorching Ray', level: 2, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  seeInvisibility: { name: 'See Invisibility', level: 2, school: 'Divination', classes: ['bard', 'sorcerer', 'wizard'], concentration: false },
  shatter: { name: 'Shatter', level: 2, school: 'Evocation', classes: ['bard', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  ...
  spiritualWeapon: { name: 'Spiritual Weapon', level: 2, school: 'Evocation', classes: ['cleric'], concentration: false },
  ...
  callLightning: { name: 'Call Lightning', level: 3, school: 'Conjuration', classes: ['druid'], concentration: true },
  ...
  conjureBarrage: { name: 'Conjure Barrage', level: 3, school: 'Conjuration', classes: ['ranger'], concentration: false },
  ...
  fireball: { name: 'Fireball', level: 3, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  hungerOfHadar: { name: 'Hunger of Hadar', level: 3, school: 'Conjuration', classes: ['warlock'], concentration: true },
  ...
  lightningBolt: { name: 'Lightning Bolt', level: 3, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  spiritGuardians: { name: 'Spirit Guardians', level: 3, school: 'Conjuration', classes: ['cleric'], concentration: true },
  ...
  vampiricTouch: { name: 'Vampiric Touch', level: 3, school: 'Necromancy', classes: ['sorcerer', 'warlock', 'wizard'], concentration: true },
  ...
  blight: { name: 'Blight', level: 4, school: 'Necromancy', classes: ['druid', 'sorcerer', 'warlock', 'wizard'], concentration: false },
  ...
  iceStorm: { name: 'Ice Storm', level: 4, school: 'Evocation', classes: ['druid', 'sorcerer', 'wizard'], concentration: false },
  ...
  phantasmalKiller: { name: 'Phantasmal Killer', level: 4, school: 'Illusion', classes: ['bard', 'wizard'], concentration: true },
  ...
  wallOfFire: { name: 'Wall of Fire', level: 4, school: 'Evocation', classes: ['druid', 'sorcerer', 'wizard'], concentration: true },
  ...
  cloudkill: { name: 'Cloudkill', level: 5, school: 'Conjuration', classes: ['sorcerer', 'wizard'], concentration: true },
  ...
  coneOfCold: { name: 'Cone of Cold', level: 5, school: 'Evocation', classes: ['druid', 'sorcerer', 'wizard'], concentration: false },
  ...
  destructiveWave: { name: 'Destructive Wave', level: 5, school: 'Evocation', classes: ['paladin'], concentration: false },
  ...
  flameStrike: { name: 'Flame Strike', level: 5, school: 'Evocation', classes: ['cleric'], concentration: false },
  ...
  insectPlague: { name: 'Insect Plague', level: 5, school: 'Conjuration', classes: ['cleric', 'druid', 'sorcerer'], concentration: true },
  ...
  chainLightning: { name: 'Chain Lightning', level: 6, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
  circleOfDeath: { name: 'Circle of Death', level: 6, school: 'Necromancy', classes: ['sorcerer', 'warlock', 'wizard'], concentration: false },
  ...
  disintegrate: { name: 'Disintegrate', level: 6, school: 'Transmutation', classes: ['sorcerer', 'wizard'], concentration: false },
  ...
  harm: { name: 'Harm', level: 6, school: 'Necromancy', classes: ['cleric'], concentration: false },
  ...
  sunbeam: { name: 'Sunbeam', level: 6, school: 'Evocation', classes: ['cleric', 'druid', 'sorcerer', 'wizard'], concentration: true },
  ...
  delayedBlastFireball: { name: 'Delayed Blast Fireball', level: 7, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: true },
  ...
  fingerOfDeath: { name: 'Finger of Death', level: 7, school: 'Necromancy', classes: ['sorcerer', 'warlock', 'wizard'], concentration: false },
  fireStorm: { name: 'Fire Storm', level: 7, school: 'Evocation', classes: ['cleric', 'druid', 'sorcerer'], concentration: false },
  ...
  prismaticSpray: { name: 'Prismatic Spray', level: 7, school: 'Evocation', classes: ['bard', 'sorcerer', 'wizard'], concentration: false },
  ...
  earthquake: { name: 'Earthquake', level: 8, school: 'Evocation', classes: ['cleric', 'druid', 'sorcerer'], concentration: true },
  ...
  incendiaryCloud: { name: 'Incendiary Cloud', level: 8, school: 'Conjuration', classes: ['druid', 'sorcerer', 'wizard'], concentration: true },
  ...
  sunburst: { name: 'Sunburst', level: 8, school: 'Evocation', classes: ['cleric', 'druid', 'sorcerer', 'wizard'], concentration: false },
  ...
  meteorSwarm: { name: 'Meteor Swarm', level: 9, school: 'Evocation', classes: ['sorcerer', 'wizard'], concentration: false },
